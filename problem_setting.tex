...
\dkcomment{Do we need this definition here?}\pfcomment{I agree that we can move the definition of phase to where we define our algorithm.}
We call time $t_{n}=\min_{t}\{\forall i, \NumPull{t}{i} \geq n\}$ the
\emph{starting point of the $n^{th}$ phase}.
