...
\pfedit{continuous}
mean-zero sub-Gaussian($\sigma^2$) noise that is independent but not necessarily identically distributed across time. \pfcomment{I used continuity below where the algorithm is defined to get rid of ties.}}
