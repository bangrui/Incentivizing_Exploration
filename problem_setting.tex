...
\dkcomment{It is unique with probablity 1 over the draw of agent types
  ...
  \pfcomment{That argument says that $\Best{\AgV}$ is unique.  But the second best, $\Second{\AgV}$, doesn't have to be.  The measure of the set of agents with 0 gap between the second- and third-best  options might not vanish.}
