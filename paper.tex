...
In this section, we prove using Algorithm~\ref{Alg1}, we can achieve $O(N^2+M(\log(T))^2)$ regret bound with $O(N)$ payment budget, where $M$ bounds the density of agents who are indifferent between their best and second best arm.
