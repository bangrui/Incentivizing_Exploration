...
Now we are ready to prove our first main result, Theorem~\ref{rst:budget}. \bccomment{The proof below only bounds the cumulative expected number of payments}
