...
\dkedit{The total expected regret incurred in these phases is at most
...
under \AccEU{\tau_s^k}{\frac{\dkedit{\EarlyCut{s}}}{2\Diam d}}, no agent at time $t$ will incur
regret more than \EarlyCut{s}.
\dkcomment{Instead of the extra case distinction, I had thought of
  defining \EarlyCut{s} to be the minimum of the current definition and
