...
\begin{abstract}
\dkcomment{Should we be changing the ``Proveedings of ...'' part on
  the top?}
\pfcomment{No, I don't think so.  The sample paper we got with the camera ready instructions also had Machine Learning Research there.} 
...
\input{algorithm_intro}
\input{algorithm_general}
\input{algorithm_payment}
\input{algorithm_regret}
