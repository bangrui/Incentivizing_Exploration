...
\usepackage{amsmath}
\usepackage{float}
\newcommand{\CTB}{CTB} % This is the acronym for our CTB algorithm
\newcommand{\CTBone}{CTB$-1$} % This is the acronym for our Bayes CTB algorithm
\newcommand{\CTBtwo}{CTB$-2$} % This is the acronym for our Bayes CTB algorithm
\newcommand{\CTBthree}{CTB$-3$}
