...
We saw in Corollary~\ref{cor:constant-regret} that \bccomment{David, could you put the right reference here?}
\dkcomment{This was supposed to be a corollary (presumably in Section
  3) we would write that would show that
  in the special case $\TieDensity = 0$, the regret is constant.}
