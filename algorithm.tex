...
\pfcomment{We can check through the whole paper on whether we have
  $\AgV \sim \AgentDist$ in the subscript or just $\AgV \sim
  \AgentDist$.  I think we have only $\AgentDist$ in the problem
  description.}
\dkcomment{There must be a typo in Peter's comment.}
